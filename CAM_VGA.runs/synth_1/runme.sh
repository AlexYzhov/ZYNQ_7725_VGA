...
HD_PWD='E:/Proj_ZYNQ/CAM_VGA/CAM_VGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CAM_PS_Configure_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CAM_PS_Configure_wrapper.tcl
