...
HD_PWD='E:/Proj_ZYNQ/CAM_VGA/CAM_VGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CAM_PS_Configure_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CAM_PS_Configure_wrapper.tcl -notrace
